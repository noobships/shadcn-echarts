# Introduction - The Elegant Bundler for Libraries
...
### Key Differences Between tsdown and Rolldown [​](#key-differences-between-tsdown-and-rolldown)
...
## What Can It Bundle? [​](#what-can-it-bundle)
...
With its built-in support for [tree shaking](./../options/tree-shaking), [minification](./../options/minification), and [source maps](./../options/sourcemap), `tsdown` ensures your library is optimized for production.

## Fast and Elegant [​](#fast-and-elegant)
...
Ready to dive in? Check out the [Getting Started](./getting-started) guide to set up your first project with `tsdown`.

Want to use tsdown from your own scripts? See [Programmatic Usage](./../advanced/programmatic-usage).
