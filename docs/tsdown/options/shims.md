# Shims - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/shims.md for this page in Markdown format
...
## CommonJS Variables in ESM [​](#commonjs-variables-in-esm)
...
## The `require` Function in ESM [​](#the-require-function-in-esm)
...
## ESM Variables in CommonJS [​](#esm-variables-in-commonjs)
