# Declaration Files (dts) - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/dts.md for this page in Markdown format

# Declaration Files (dts) [​](#declaration-files-dts)
...
## How dts Works in tsdown [​](#how-dts-works-in-tsdown)
...
## Enabling dts Generation [​](#enabling-dts-generation)
...
### Enable in `tsconfig.json` [​](#enable-in-tsconfig-json)
...
### Enable in tsdown Config [​](#enable-in-tsdown-config)
...
### With `isolatedDeclarations` [​](#with-isolateddeclarations)
...
### Without `isolatedDeclarations` [​](#without-isolateddeclarations)
...
## Build Process for dts [​](#build-process-for-dts)
