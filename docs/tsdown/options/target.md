# Target - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/target.md for this page in Markdown format
...
## Default Target Behavior [​](#default-target-behavior)
...
## Disabling Target Transformations [​](#disabling-target-transformations)
...
## Customizing the Target [​](#customizing-the-target)
...
> **Note:** The two decorator implementations are very different. Make sure you are using the correct configuration and syntax for your chosen decorator version.

# CSS Targeting [​](#css-targeting)
