# Output Format - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/output-format.md for this page in Markdown format
...
## Overriding Configuration by Format [​](#overriding-configuration-by-format)
