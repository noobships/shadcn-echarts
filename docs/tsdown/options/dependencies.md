# Dependencies - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/dependencies.md for this page in Markdown format
...
### `devDependencies` and Phantom Dependencies [​](#devdependencies-and-phantom-dependencies)
...
## Skipping Node Modules Bundling [​](#skipping-node-modules-bundling)
...
## Customizing Dependency Handling [​](#customizing-dependency-handling)
...
## Handling Dependencies in Declaration Files [​](#handling-dependencies-in-declaration-files)
...
### Resolver Option [​](#resolver-option)
