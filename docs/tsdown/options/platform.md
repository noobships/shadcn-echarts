# Platform - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/platform.md for this page in Markdown format
