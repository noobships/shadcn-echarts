# Config File - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/config-file.md for this page in Markdown format
...
### Building Multiple Outputs [​](#building-multiple-outputs)
...
## Specifying a Custom Config File [​](#specifying-a-custom-config-file)
...
## Extending Vite or Vitest Config (Experimental) [​](#extending-vite-or-vitest-config-experimental)
...
For a full list of available configuration options, refer to the [Config Options Reference](./../reference/api/Interface.UserConfig). This includes detailed explanations of all supported fields and their usage.