# CJS Default Export - The Elegant Bundler for Libraries

Are you an LLM? You can read better optimized documentation at /options/cjs-default.md for this page in Markdown format

# CJS Default Export [​](#cjs-default-export)
...
-   `export default ...` into `module.exports = ...` in the generated JavaScript file.
