...
<iframe width="450" height="300" src="https://echarts.apache.org/examples/en/view.html?c=doc-example/text-block-fragment"></iframe>
      ...
      label: {
        ...
        rich: {
          ...
          sunny: {
            ...
            backgroundColor: {
              image:
                'https://echarts.apache.org/examples/data/asset/img/weather/sunny\_128.png'
            }
          },
          cloudy: {
            height: 30,
            ...
            backgroundColor: {
              image:
                'https://echarts.apache.org/examples/data/asset/img/weather/cloudy\_128.png'
            }
          },
          showers: {
            height: 30,
            ...
            backgroundColor: {
              image:
                'https://echarts.apache.org/examples/data/asset/img/weather/showers\_128.png'
            }
          }
        }
      }
...
[Edit](./editor.html?c=doc-example%2Ftext-block-fragment)
