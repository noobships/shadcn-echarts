...
ECharts have a simple loading animation by default. You can call [showLoading](https://echarts.apache.org//api.html#echartsInstance.showLoading) to display. When the data loading was completed, call [hideLoading](https://echarts.apache.org//api.html#echartsInstance.hideLoading) to hide the animation.
...
All data's updates were implemented by [setOption](https://echarts.apache.org//api.html#echartsInstance.setOption). You only need to fetch the data periodically. ECharts will find the difference between two groups of data to use the proper way to choose the animation.
